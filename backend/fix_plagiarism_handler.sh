#!/bin/bash
# fix_plagiarism_handler.sh

echo "Fixing syntax errors in plagiarism_handler.rs..."

# Create a clean version of plagiarism_handler.rs
cat > src/api/handlers/plagiarism_handler.rs << 'EOF'
...
echo "Fixed plagiarism_handler.rs. Running cargo check..."
cargo check
