#!/bin/bash
# fix_member_handler.sh

echo "Fixing syntax errors in member_handler.rs..."

# Create a clean version of member_handler.rs
cat > src/api/handlers/member_handler.rs << 'EOF'
...
echo "Fixed member_handler.rs. Running cargo check..."
cargo check
