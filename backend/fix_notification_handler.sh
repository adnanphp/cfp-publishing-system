#!/bin/bash
# fix_notification_handler.sh

echo "Fixing syntax errors in notification_handler.rs..."

# Create a clean version of notification_handler.rs
cat > src/api/handlers/notification_handler.rs << 'EOF'
...
echo "Fixed notification_handler.rs. Running cargo check..."
cargo check
